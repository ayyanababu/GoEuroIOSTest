 ...
 */
@objc public class ResourceManager:NSObject,DownloadsManagerDelegate
{
    ...
    */
    ...
    /*
     ...
     identifier is used add observers to a resource. If the calling object no longer needs data 
     then it can use this identifier to remove observers.
